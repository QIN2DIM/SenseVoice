...
def model_inference(input_wav, language, fs=16000):
    ...
    text = model.generate(
        input=input_wav, cache={}, language=language, use_itn=True, batch_size_s=0, merge_vad=merge_vad
    )
...
def launch():
            ...
            with gr.Column():
                ...
                with gr.Accordion("Configuration"):
                    language_inputs = gr.Dropdown(
                        choices=["auto", "zh", "en", "yue", "ja", "ko", "nospeech"], value="auto", label="Language"
                    )
    ...
    demo.launch(server_port=50310, share=True)
